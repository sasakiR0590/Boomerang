...
void UI::Draw() {
	...
	//	SpriteBatch.DrawString(time_over_font, Vector2(130, 100), Color(255,255, 255), _T("“GŒ‚”jƒ{[ƒiƒX"));
	//if(EnemyManager::Instance().GetEnemyDeath())
	//	SpriteBatch.DrawString(time_over_font, Vector2(200, 150), Color_Red, _T("+%.1f•b"),ENEMYADDTIME);
